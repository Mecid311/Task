...
namespace TaskWebUI.Areas.Admin.Controllers
{
    ...
    public class AboutsController : Controller
    {
        ...
        public AboutsController(TaskDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Text")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Text")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
